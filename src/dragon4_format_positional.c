...
static void	help1(t_format_arg *arg, int32_t print_exponent,
					uint32_t *num_print_digits, uint32_t *num_fraction_digits)
{
...
static void set_zero_and_point(t_format_arg *arg, uint32_t *num_print_digits)
{
...
static void	help2(t_format_arg *arg, int32_t print_exponent,
					uint32_t *num_print_digits, uint32_t *num_fraction_digits)
{
	...
	if (arg->buffer_size - 1 > 2)
	{
		...
		*num_fraction_digits = *num_print_digits;
		...
		if (*num_fraction_digits > max_fraction_digits)
			*num_fraction_digits = max_fraction_digits;
		ft_memmove(arg->out_buffer + digits_start_idx, arg->out_buffer, *num_fraction_digits);
